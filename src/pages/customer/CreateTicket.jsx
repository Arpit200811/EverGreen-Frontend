...
const schema = yup.object({
  customerName: yup
    ...
    .matches(
      /^[a-zA-Z\s]{3,20}$/,
      "Name should only contain letters and be at least 3 chars long"
    )
  ...
  location: yup
    .string()
    .min(5, "Please enter a more detailed location")
    .required("Location is required"),
  deviceModel: yup
    .string()
    .matches(
      /^[a-zA-Z0-9\s\-\.\/]{2,30}$/,
      "Enter a valid brand and model name"
    )
    ...
    try {
      ...
      Swal.fire({
        ...
        html:
          ...
          "<br>We'll call you in 15 minutes.",
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          <div>
            ...
            <p className="text-slate-500 font-medium">
              Get your electronics fixed by certified experts.
            </p>
          </div>
          <div className="flex items-center gap-3 bg-white p-2 rounded-2xl shadow-sm border border-slate-100">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-8 h-8 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-[10px] text-white font-bold italic"
                >
                  {i === 4 ? "4.9★" : ""}
                </div>
              ))}
            </div>
            <p className="text-xs font-black text-slate-600 uppercase pr-2">
              12k+ Happy Customers
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-10">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  <span className="w-8 h-8 bg-emerald-600 text-white rounded-lg flex items-center justify-center font-black text-xs italic">
                    01
                  </span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {deviceCategories.map((device) => (
                    ...
                    >
                      <device.icon
                        size={32}
                        strokeWidth={selectedDevice === device.id ? 2.5 : 1.5}
                      />
                ...
                {errors.deviceType && (
                  <p className="text-rose-500 text-[10px] font-bold ml-2 tracking-wide uppercase">
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-2 group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-4 bg-slate-50 border-transparent rounded-2xl text-sm font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/20 focus:bg-white transition-all outline-none border border-slate-50"
                        placeholder="e.g. MacBook Air M2"
                      />
                      {errors.deviceModel && (
                        <p className="text-rose-500 text-[10px] font-bold mt-1 ml-2 uppercase tracking-wide">
                ...
                <div className="space-y-2 group">
                  ...
                  <div className="relative">
                    <MessageSquare
                      className="absolute left-4 top-5 text-slate-300 group-focus-within:text-emerald-500 transition-colors"
                      size={18}
                    />
                    <textarea
                      {...register("issueDescription")}
                      rows={3}
                      className="w-full pl-12 pr-4 py-4 bg-slate-50 border-transparent rounded-2xl text-sm font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/20 focus:bg-white transition-all outline-none border border-slate-50 resize-none"
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-emerald-900 p-10 rounded-[3rem] text-white relative overflow-hidden shadow-2xl shadow-emerald-200">
              ...
              <h4 className="text-2xl font-black mb-6 italic leading-tight">
                Why Book With Us?
              </h4>
              <div className="space-y-8">
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center border border-white/10">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-emerald-100/60 font-medium">
                      Engineer visit within 60-90 minutes.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
